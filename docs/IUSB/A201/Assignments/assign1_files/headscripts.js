...
function setMainFrameHeightNow(id)
{
	...
	try
	{
		var test = parent.document.getElementById(id);
		// if we made it here, set the frame var as normal
		var frame = parent.document.getElementById(id);
	}
	catch( e )
	{
		// if we are here, reestablish document.domain then set frame var for SIS problem
		document.domain = indiana.edu;
		var frame = parent.document.getElementById(id);
	}
	if (frame)
	{
